  ...
  return (
    ...
    >
      <div className="mb-4 flex justify-between items-center">
        ...
        <button onClick={handleFilter} className={`bg-blue-500 text-white px-4 py-2 ml-4 rounded-md ${
          ...
          {sortedProducts.map((product) => (
            <tr key={product.id} className="border-b">
              ...
              <td className="py-2 px-4 border-r">
                <img src={product.photo} alt={`Product ${product.name}`} className="max-w-16 h-auto" />
              </td>
              ...
              <td className="py-2 px-4">
                <button onClick={() => handleEdit(product)} className={`text-blue-500 hover:underline mr-2 ${
                    nightMode ? 'hover:text-blue-300' : 'hover:text-blue-700'
                  }`}>
                  Edit
                </button>
                <button onClick={() => onDelete(product.id)} className={`text-red-500 hover:underline ${
                    nightMode ? 'hover:text-red-300' : 'hover:text-red-700'
                  }`}>
                  Delete
                </button>
              </td>
