  ...
  return (
    <div className="fixed top-0 left-0 w-full h-full bg-gray-800 bg-opacity-75 flex items-center justify-center">
      <div className="bg-white p-6 rounded-md w-96">
        ...
        <Dropzone onDrop={(acceptedFiles) => handlePhotoDrop(acceptedFiles)}>
          {({ getRootProps, getInputProps }) => (
            <div {...getRootProps()} className="w-full p-2 border border-gray-300 rounded-md cursor-pointer">
              <input {...getInputProps()} />
              <p className="text-center">Drag & drop a photo here, or click to select one</p>
            </div>
          )}
        </Dropzone>
      </div>
