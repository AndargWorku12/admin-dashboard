          ...
          <div key={category.id} className="flex-shrink-0 bg-white p-4 rounded-lg shadow-lg">
            ...
            <div>
              ...
              <div className="mt-4 flex space-x-2">
                <button onClick={() => setEditingCategory(category)} className="cat__category p-2 rounded">Edit</button>
                <button onClick={() => confirmDelete(category)} className="cat__category p-2 rounded">Delete</button>
              </div>
            </div>
          </div>
        ))}
