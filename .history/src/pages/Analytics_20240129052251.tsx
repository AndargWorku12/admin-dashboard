  ...
  return (
    <div className="container mx-auto my-8">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        {/* Total Metrics Cards */}
        <div className="col-span-3 md:col-span-2 lg:col-span-1 flex justify-between gap-8">
...
<div className='gap-8 col-span-3 md:col-span-2 lg:col-span-1 flex justify-between'>
          <div className="bg-white p-4 rounded-lg shadow-lg flex-1 mr-4">
