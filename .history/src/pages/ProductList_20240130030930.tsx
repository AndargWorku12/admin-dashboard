...
//   const sortProducts = (key: string, order: 'asc' | 'desc') => {
...
//       <button onClick={() => setAddProductModalOpen(true)} className="bg-blue-500 text-white px-4 py-2 rounded">
//         Add Product
//       </button>
//       <ProductTable
//         products={products}
...
// // //   return (
// // //     <div className="container mx-auto my-8 w-50">
// // //       <button
// // //         onClick={() => {
// // //           setModalOpen(true);
