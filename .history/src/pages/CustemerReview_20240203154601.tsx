...
const ReviewForm: React.FC<ReviewFormProps> = ({ initialReview, onSubmit }) => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <select id="rating" name="rating" value={rating} onChange={(e) => setRating(parseInt(e.target.value, 10))}>
      ...
      <input type="file" id="photo" name="photo" accept="image/*" onChange={handleFileInputChange} />
