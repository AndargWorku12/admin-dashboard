        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="bg-white p-8 rounded-lg">
            ...
            <div className="flex justify-end">
              <button onClick={createCategory} className="create text-white p-2 rounded">Create</button>
              <button onClick={() => setAddModalOpen(false)} className="cat_cancel ml-2 text-white p-2 rounded">Cancel</button>
            </div>
          </div>
        </div>
      )}
