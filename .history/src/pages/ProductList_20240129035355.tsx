...
const ProductList: React.FC = () => {
  ...
  return (
    <div className="container mx-auto my-8 w-70">
      <button
        onClick={() => {
          setModalOpen(true);
          setSelectedProduct(null);
        }}
        className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mb-4 block"
      >
        Add Product
      </button>
      {isModalOpen && (
      ...
      <div className="bg-gray-100 p-6 rounded-lg shadow-2xl overflow-x-auto">
              ...
              <tr key={product.id} className="border-t">
                ...
                <td className="px-4 py-2">
                  <button
                    ...
                    className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded mr-2 block"
                  >
                    Edit
                  </button>
                  <button
