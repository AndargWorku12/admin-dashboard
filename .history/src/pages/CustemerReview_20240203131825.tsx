...
const ReviewPage: React.FC = () => {
  const initialReviews: Review[] = [
    { id: 1, name: 'John Doe', comment: 'Great product!', rating: 5, photo: '' },
    { id: 2, name: 'Jane Smith', comment: 'Not bad, but could be better.', rating: 3, photo: '' },
    { id: 3, name: 'Alice Johnson', comment: 'Excellent service!', rating: 4, photo: '' },
    { id: 4, name: 'Bob Williams', comment: 'Product was damaged upon arrival.', rating: 2, photo: '' },
    { id: 5, name: 'Eva Davis', comment: 'Fast shipping, good quality.', rating: 5, photo: '' },
  ];
        ...
        <tbody>
          {reviews.map((review) => (
            <tr key={review.id}>
              ...
              <td>
                {review.photo && (
                  <img src={review.photo} alt={`Review by ${review.name}`} className="w-12 h-12 object-cover" />
                )}
              </td>
              <td>
                <button
