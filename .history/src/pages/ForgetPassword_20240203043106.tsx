        ...
        <div className="p-4 sm:p-7">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <a className="nb decoration-2 hover:underline font-medium" href="/login">
                Login here
              </a>
            </p>
          </div>
          ...
          <div className="mt-5">
            <form>
              <div className="grid gap-y-4">
                ...
                <button
                  type="submit"
                  className="login py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold text-white focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-all text-sm dark:focus:ring-offset-gray-800"
                >
                  Reset password
                </button>
              </div>
