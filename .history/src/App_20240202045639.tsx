...
const sampleSaleData: SaleData[] = [
  ...
  { value: 75, label: 'February' },
  { value: 100, label: 'March' },
];

const sampleRevenueData: RevenueData[] = [
  { value: 300, label: 'Product A' },
  { value: 450, label: 'Product B' },
  { value: 200, label: 'Product C' },
];
...
const handleDeleteCategory = (categoryId: string) => {
  ...
  return (
    ...
    <Sidebar>
      <Routes>
        <Route path="/" element={<Dashboard saleData={sampleSaleData} revenueData={sampleRevenueData} />}/>
        {/* saleData={saleData} revenueData={revenueData}  />} /> */}
        <Route path="/dashboard" element={<Dashboard saleData={sampleSaleData} revenueData={sampleRevenueData} />}/>
         {/* saleData={saleData} revenueData={revenueData}  />} /> */}
